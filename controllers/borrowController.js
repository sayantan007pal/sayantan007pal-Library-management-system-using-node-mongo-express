// controllers/borrowController.js - Enhanced controller with Joi validation
...
const { 
  ...
  validateRenewBook, 
  validatePayFine,
  validateGetAllBorrowRecords 
} = require('../validation/borrowValidation');

// Get all borrow records with optional filtering - Add validation middleware
exports.getAllBorrowRecords = [
  validateGetAllBorrowRecords,
  async (req, res, next) => {
    try {
      const { 
...
// Create a new borrow record (check out a book) - Add validation middleware
exports.createBorrowRecord = [
  validateCreateBorrow,
  async (req, res, next) => {
    try {
...
// Update a borrow record - Add validation middleware
exports.updateBorrowRecord = [
  validateUpdateBorrow,
  async (req, res, next) => {
    try {
...
// Return a book - Add validation middleware
exports.returnBook = [
  validateReturnBook,
  async (req, res, next) => {
    try {
...
// Renew a book loan - Add validation middleware
exports.renewBook = [
  validateRenewBook,
  async (req, res, next) => {
    try {
...
// Pay fine - Add validation middleware
exports.payFine = [
  validatePayFine,
  async (req, res, next) => {
    try {
